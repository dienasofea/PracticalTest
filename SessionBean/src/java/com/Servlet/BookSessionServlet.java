/*
Booking Controller (10 Marks): Create a Servlet named BookSessionServlet. 
o Use the doPost() method to retrieve parameters (student_name, branch_location, 
lesson_type) from the HTML form. 
o Instantiate SessionBean, set the retrieved values (default status to "Booked"), and 
pass the object to the SessionDAO to save it. 
o Upon success, use response.sendRedirect() to redirect the user to the Schedule 
Servlet. 
*/
package com.Servlet;
